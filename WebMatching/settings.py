"""
Django settings for WebMatching project.
...
SECRET_KEY = 'django-insecure-!#l$6nc+d@volsvq+$8ne_e58a1qsi8qe=n6d6rx78^9z5!)ep'
...
WSGI_APPLICATION = 'WebMatching.wsgi.application'
ASGI_APPLICATION = 'WebMatching.asgi.application'
